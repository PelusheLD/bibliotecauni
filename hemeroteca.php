		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5">
					<h3>Hemeroteca</h3>
					<p>
						Todo tipo de teesis y archivos publicos proporcionados por la universidad para todo aquel que lo necesite
					</p>
					<a href="busqueda.php"><button type="submit" class="btn" name="login">Investigar</button></a>
				</div>
			</div>
		</div>
		<br>
