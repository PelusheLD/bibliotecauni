...
$nroProductos = mysqli_num_rows(mysqli_query($con, "SELECT * FROM administrador_biblioteca"));
$nroLotes = 8;
...
$registro = mysqli_query($con, "SELECT * FROM administrador_biblioteca LIMIT $limit, $nroLotes ");
