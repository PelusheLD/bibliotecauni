...
if (isset($_SESSION['user'])) { ?>
    ...
    <head>
        ...
        <script src="profesores/myjava.js"></script>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h1 class="page-header">
                    <small><img src="images/logo1.jpeg" width=180px height=90px></small> Profesores
                </h1>
                <!-- /.row -->
                <section>
                    <table border="0" align="left">
                        <tr>
                            <td style="margin-rigth:20px;"><B> Buscar Profesor: </B></td>
                            <td>&nbsp; &nbsp;</td>
                            ...
                            <td></td>
                            <td></td>
                            <td width="100"><button id="nuevo-producto" class="btn btn-success">Nuevo Profesor</button></td>
                            <td>&nbsp; &nbsp;</td>
                            <td width="200"></td>
                        </tr>
                    </table>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background:#839ca9;">
                                ...
                                <h4 class="modal-title" style="color:white;" id="myModalLabel"><b>Profesores del Sistema</b></h4>
                            </div>
                            <form id="formulario" class="form-group" onsubmit="return agregaProfesor();">
