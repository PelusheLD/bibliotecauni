        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h1 class="page-header">
                    <small><img src="images/logo1.jpeg" width=180px height=90px></small> Reportes
                </h1>
                <!-- /.row -->
                <section>
                    <table border="0" align="left">
                        <tr>
                            <td style="margin-rigth:20px;"><B> Buscar reporte: </B></td>
                            <td>&nbsp; &nbsp;</td>
                            <td width="335"><input type="text" placeholder="Buscar por fecha" id="bs-prod" style="border-radius:10px; padding-left:5px; heigth:25px; width:90%" /></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td width="100"><button id="nuevo-producto" class="btn btn-success">Generar Reporte</button></td>
                            <td>&nbsp; &nbsp;</td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background:#839ca9;">
                                ...
                                <h4 class="modal-title" style="color:white;" id="myModalLabel"><b>Generar Reporte</b></h4>
                            </div>
