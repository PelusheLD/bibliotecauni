        ...
        <script>
            $(document).ready(function() {
                ...
                $('#bs-prod').on('keyup', function() {
                    ...
                    $.ajax({
                        url: 'buscar_sancionados.php', // Ruta al archivo PHP que realizará la búsqueda en el servidor
                        method: 'POST',
                        data: {
                            searchText: searchText,
                            tipoBusqueda: tipoBusqueda
                        }, // Enviar el texto de búsqueda y el tipo de búsqueda al servidor
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h1 class="page-header">
                    <small><img src="images/logo1.jpeg" width=180px height=90px></small> Sanciones
                </h1>
                <!-- /.row -->
                <section>
